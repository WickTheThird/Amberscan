...
<div
	class="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl select-none"
>
	<div class="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
		<div class="self-start hidden lg:flex flex-col text-gray-300">
			<h1 class="my-3 font-semibold text-4xl">Welcome back</h1>
			<p class="pr-3 text-sm opacity-75">
				Whether you're submitting photos, uploading PDFs, or accessing financial reports, we've got
				you covered. Let's work together to make invoicing easier and more efficient than ever!
			</p>
		</div>
	</div>
				...
				<div class="flex justify-center gap-5 w-full">
					...
					>
						<svg
							...
							</style><g id="Layer_1" /><g id="Layer_2"
								><path
