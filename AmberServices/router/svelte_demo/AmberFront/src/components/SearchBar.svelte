...
<div class="max-w-2xl mx-auto mt-5 w-screen fixed z-10 overscroll-y-none">

	<form class="flex items-center z-10">   
        <label for="voice-search" class="sr-only z-10">Search</label>
